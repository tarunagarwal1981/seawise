...
def show_cii_calculator():
    ...
    with col3:
        st.markdown("<div class='placeholder-text'>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>", unsafe_allow_html=True)
